...
class Infrastructure:
    ...
    def list(self, **kwargs):
        ...
        self.opencti.app_logger.info("Listing Infrastructures with filters",
        ...
        if get_all:
            ...
            while result["data"]["infrastructures"]["pageInfo"]["hasNextPage"]:
                after = result["data"]["infrastructures"]["pageInfo"][
                    "endCursor"]
                self.opencti.app_logger.info("Listing Infrastructures",
                                             {"after": after})
                result = self.opencti.query(
                    query,
                    {
    ...
    def create(self, **kwargs):
        ...
        if name is not None:
            self.opencti.app_logger.info("Creating Infrastructure",
                                         {"name": name})
            query = """
